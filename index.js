...
app.get("/", (req, res) => {
    ...
    res.send("Rotas: \n" + "/usuarios -> para listar todos os funcionarios" + "/usuarios/:id -> para listar um usuario especifico pelo codigo id");
});
        ...
        client.query(
            ...
            function (err, result) {
                if (err) {
                    ...
                    res.setHeader("id", id);
                    res.status(202).json({ "alterado o identificador": id });
                    console.log(result);
                }
            }
        );
